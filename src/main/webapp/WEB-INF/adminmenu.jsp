...
<li><a class="idTabs" href="#students"><img
	...
	<ul class="noJS">
		<li>
			<a>	<li><a href="createStudent.php?page=createStudent"><img
					src="icons/user_add.png" /> Create Student</a></li></a>
			<a
			href="liststudent.php?page=students&&user_role=adm&&action=list"><img
